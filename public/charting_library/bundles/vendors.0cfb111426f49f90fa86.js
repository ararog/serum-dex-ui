    ...
    '0+LD': function (e, t, n) {
      ...
      e.exports = function (e, t, n, g, v, m) {
        ...
        if (
          ...
          (_ = g.getConstructor(t, e, v, b)), s(_.prototype, n), (a.NEED = !0);
        return (
          p(_, e),
          (x[e] = _),
          o(o.G + o.W + o.F * (_ != y), x),
      ...
      ((t = e.exports = function (e, t, n, f, d) {
        ...
        if (i(m)) {
          for (p = a(e.length); p > _; _++)
            if ((v = t ? y(s((h = e[_]))[0], h[1]) : y(e[_])) === l || v === c)
              return v;
        } else
          for (g = m.call(e); !(h = g.next()).done; )
            if ((v = o(g, y, h.value, t)) === l || v === c) return v;
      }).BREAK = l),
        (t.RETURN = c);
    },
    Blyn: function (e, t, n) {
        ...
        toggleClass: function (e, t) {
          ...
          return i.isFunction(e)
            ...
            : this.each(function () {
                if ('string' === n)
                  for (
                    var o, s = 0, a = i(this), u = t, l = e.split(m);
                    (o = l[s++]);
            ...
            for (; o < 4; o += 2)
              n || (r -= parseFloat(i.css(e, 'padding' + Se[o])) || 0),
                'margin' === n
                  ...
                  : (r -=
                      parseFloat(i.css(e, 'border' + Se[o] + 'Width')) || 0);
          return r + 'px';
        }
    ...
    YFKU: function (e, t, n) {
            ...
            d(t, [
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    this.modules.logger
                      ? _.init(r(this.modules.logger), this.options)
                      : _.init(null, this.options);
      ...
      if (!G.__tradingviewI18nextInited) {
        var Z = window.language || null,
          ee = oe(Z);
        (Z && ee) ||
          (console.error('No translation data'), (Z = 'en'), (ee = oe('en')));
        var te = (function (e) {
          return Y[e] || e;
        })(Z);
        if (Z && ee) {
